const burgers = [
  {
    ...
    ingredients: ['Swiss Cheese', 'Beef Patty', 'Sliced Ham', 'Butter Sautéed Mushrooms', 'Dijon Mustard', 'Mayonnaise', 'Potato Roll'],
  ...
  },
  {
    ...
    ingredients: ['Butterkäse Cheese', 'Beef Patty', 'Beer Mustard', 'Smoked Chopped Ham', 'Sautéed Onions', 'Frisée Lettuce', 'Pretzel Bun'],
  ...
  },
  {
    ...
    ingredients: ['Cheddar Cheese', 'Beef Patty', 'Iceberg Lettuce', 'Tomatoes', 'Bacon', 'Ketchup', 'Red Onions', 'Grilled Potato Roll'],
  ...
  },
  {
    ...
    ingredients: ['Brie Cheese', 'Beef Patty', 'Apple Butter', 'Aged Dijon Mustard', 'Spinach', 'Toasted Brioche Loaf'],
  ...
  },
  {
    ...
    ingredients: ['Blue Cheese', 'Beef Patty', 'Watercress', 'Peppered Bacon', 'Pickled Red Onions', 'Balsalmic Mayonnaise', 'Toasted Ciabatta Roll'],
  ...
  },
  {
    ...
    ingredients: ['Brick Cheese', 'Beef Patty', 'BQQ Sauce', 'Peppered Pork', 'Onion Rings', 'Boston Bibb Lettuce', 'Toasted Sesame Bun'],
  ...
  },
  {
    ...
    ingredients: ['Feta Crumbles', 'Beef Patty', 'Sliced Tomatoes', 'Chippolini Onions', 'Arugula', 'Kalamata Olives', 'Italian Dressing', 'Poppy Seed Challah Roll'],
  ...
  },
  {
    ...
    ingredients: ['Fresh Mozzarella Cheese', 'Parmesan Cheese', 'Beef Patty', 'Smoked Bacon', 'Cucumbers', 'Vidalia Onions', 'Roma Tomatoes', 'Ranch Dressing', 'Toasted Roll'],
  ...
  },
  {
    ...
    ingredients: ['Lighlty Aged Cheddar Cheese', 'Aged Swiss Cheese', 'Beef Patty', 'Pickles', 'Yello Mustard', 'Yellow Onions', 'Chopped Iceberg Lettuce', 'Toasted White Bread'],
  ...
  },
  {
    ...
    ingredients: ['Havarti Cheese', 'Provolone Cheese', 'Beef Patty', 'Capicola', 'Pickled Jalapeños', 'Pepperoncini', 'Fresh Dill', 'Italian Roll'],
  ...
  },
  {
    ...
    ingredients: ['Brick Cheese', 'Medium Aged Cheddar Cheese', 'Beef Patty', 'Thickly Cut Ham', 'Fried Egg', 'Pepperoncini', 'Onion Rings', 'BBQ Sauce', 'Toasted Knot Bun'],
  ...
  },
  {
    ...
    ingredients: ['Gruyère Cheese', 'Beef Patty', 'Caramelized Onions', 'Thinkly Cut Bacon', 'Onion Rings', 'Toasted Onion Roll'],
  ...
  },
  {
    ...
    ingredients: ['Asiago Cheese', 'Beef Patty', 'Arugala', 'Fried Prosciutto', 'Onions', 'Olive Tapenade', 'Diced Tomatoes', 'Fresh Basil Leaves', 'Rosemary Ciabatta'],
  ...
  },
  {
    ...
    ingredients: ['Camembert Cheese', 'Beef Patty', 'Olive Oil Sautéed Mushrooms', 'Thickly Cut Bacon', 'Dijon Mayonnaise', 'Caramelized Onions', 'Heirloom Tomatoes', 'Brioche Roll'],
  ...
  },
  {
    ...
    ingredients: ['Monterey Jack Cheese', 'Beef Patty', 'Crab Meat', 'Avocado', 'Fresh Tomatoes', 'Romaine Lettuce', 'Caramalized Onions', 'Sourdough Roll'],
  ...
  },
  {
    ...
    ingredients: ['Fresh Swiss Cheese', 'Beef Patty', 'Sautéed Wild Mushrooms', 'Cremini Mushrooms', 'Rosemary', 'Crisp Bacon', 'Garlic Aioli', 'Lettuce', 'Sesame Seed Bun'],
  ...
  },
  {
    ...
    ingredients: ['Blue Cheese', 'Beef Patty', 'Thick-cut Potato Chaps', 'Smoked Pepper Pork', 'Pancetta', 'Caramelized Onions', 'Halved Potato Roll'],
  ...
  },
  {
    ...
    ingredients: ['Sliced Cheddar Cheese', 'Thinly Sliced Swiss Cheese', 'Beef Patty', 'Pork Belly', 'Light Ketchup', 'Pickles', 'Caramelized Onions', 'Kaiser Roll'],
  ...
  },
  {
    ...
    ingredients: ['Monterey Jack Cheese', 'Long Aged Cheddar Cheese', 'Beef Patty', 'Avocado', 'Refried Beans', 'Picked Jalapeños', 'Green Leaf Lettuce', 'Onions', 'Mexican Roll'],
  ...
  },
  {
    ...
    ingredients: ['Thickly Sliced Swiss Cheese', 'Beef Patty', 'Corned Beef', 'Sauerkraut', 'Thousand Island Dressing', 'Grilled Dark Rye'],
  ...
  },
  {
    ...
    ingredients: ['Mozzarella Cheese', 'Beef Patty', 'Pepperoni', 'Lightly Sautéed Mushrooms', 'Pizza Sauce', 'Caramelized Onions', 'Rustic Italian Roll'],
  ...
  },
  {
    ...
    ingredients: ['Cheese Curds', 'Beef Patty', 'Split Bratwurst', 'Caramelized Onions', 'Grolsch Beer Mustard', 'Sauerkraut', 'Kaiser Roll'],
  ...
  },
  {
    ...
    ingredients: ['Blue Cheese', 'Beef Patty', 'Toasted Walnuts', 'Dried Tart Cherries', 'Curly Endive', 'Onions', 'Thinly Spread Dijon Mustard', 'Rustic Italian Roll'],
  ...
  },
  {
    ...
    ingredients: ['Shredded Swiss Cheese', 'Beef Patty', 'Grilled Ham Slice', 'Roasted Pork Shoulder', 'Pickles', 'Yellow Mustard', 'Pressed French Bread'],
  ...
  },
  {
    ...
    ingredients: ['Smoked Cheddar Cheese', 'Beef Patty', 'Maple Bacon', 'Sautéed Apples', 'While Grain Mustard', 'Caramelized Onions', 'Sourdough Loaf'],
  ...
  },
  {
    ...
    ingredients: ['White Cheddar Cheese', 'Grated Swiss Cheese', 'Beef Patty', 'Tortilla Chips', 'Pickled Jalapeños', 'Onions', 'Fresh Iceberg Lettuce', 'Black Olives', 'Buttered Potato Roll'],
